...
import me.ryan_s.xml.data.Member;
import me.ryan_s.xml.data.Table;
import me.ryan_s.xml.data.User;
...
public class Main extends Application {
    ...
    public static void show(Stage primaryStage, String fileName, String title, int width, int height) {//special method allowing you to switch windows
        try {
            Parent root = FXMLLoader.load(Main.class.getResource(fileName + ".fxml"));//find the valid gui plan
