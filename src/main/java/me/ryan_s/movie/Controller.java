...
public class Controller {
    ...
    private final ObservableList<Movie> list;
    private final FilteredList<Movie> movies = new FilteredList<>(list = FXCollections.observableArrayList(), p -> true);
    private final File file = new File(System.getProperty("user.dir") + "/movies.txt");
